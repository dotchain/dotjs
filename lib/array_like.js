...
// CreateArrayLike is a builder for the ArrayLike class. 
//
...
export function CreateArrayLike(services) {
    const empty = [];

    // ArrayLike is an effective singleton -- specific classes are
    // implemented by using the `ofConstructor` sub method.
    return class ArrayLike {
